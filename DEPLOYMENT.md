...
Обе части на Vercel проверены живыми запросами — адреса и что именно доказано см. в шаге 7.
Docker и Fly не проверял никто: первый `fly deploy` и будет проверкой, а то, что она вскроет,
надо править здесь, а не обходить.
...
| воркер  | **нет** — шаг 4 отложен до карты на Fly                                   |
...
Последние две строки таблицы ждут воркера.
